...
<head>
<meta charset="UTF-8">
<title>¡Ooops! Hubo un error</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<link
    href="https://fonts.googleapis.com/css?family=Anonymous+Pro:400,700"
    rel="stylesheet">
<link rel="stylesheet"
    href="<%=request.getContextPath()%>/css/error500/style.css">
<body>
    ...
    <main class="page fade-in">
        ...
        <div class="flex-container" id="error-message">
            <div>
                <h1>500</h1>
                <h2>Oooops! Error interno del servidor. Algo fall&oacute; exitosamente.</h2>
            </div>
            <div>
                <p>
                   No te preocupes, el error ya ha sido reportado. Mientras tanto, 
                   <span class="underlined">aplasta unos cuantos bichos</span>. Tenemos toda clase de chanclas
                </p>
            </div>
        </div>
        <div id="game-canvas">
    ...
    <script src="<%=request.getContextPath()%>/js/error500/script.js"></script>
</body>
</html>